...
| NEXT_PUBLIC_MEMPOOL_URL | `string` | URL of the mempool API endpoint. If not provided, the mempool feature will be disabled. | - | - | `https://mempool.blockscout.com` | v1.36.0+ |
